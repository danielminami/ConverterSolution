<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Weight.aspx.cs" Inherits="UnitesWebConverterGroup_P14_1205_11181_2.Weight" %>
    ...
    <form id="form1" runat="server">
        <div class="auto-style1">
            ...
            <asp:DropDownList ID="DropDownFrom" runat="server">
                <asp:ListItem Selected="True" Value="P">Pound</asp:ListItem>
